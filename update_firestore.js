...
const competitions = [
    ...
    { id: 'soccer_france_ligue_two', displayName: 'Ligue 2' },
    { id: 'soccer_italy_serie_a', displayName: 'Serie A' },
    { id: 'soccer_turkey_super_league', displayName: 'Süper Lig' },
    { id: 'soccer_netherlands_eredivisie', displayName: 'Eredivisie' }
];
...
async function fetchTodaysMatches() {
    ...
    return allMatches.sort((a, b) => new Date(a.commence_time) - new Date(b.commence_time));
}
